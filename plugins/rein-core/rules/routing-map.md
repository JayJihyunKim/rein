...
| 버그 수정 | `rein:feature-builder-fix` | `rein:codex-review` | 재현 테스트 |
| 리팩토링 | `rein:feature-builder-refactor` | `rein:codex-review` | 동작 불변 |
| plan 작성 | `rein:plan-writer` | `rein:writing-plans` | covers 매트릭스 |
