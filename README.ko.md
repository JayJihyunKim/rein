...
최신 릴리즈: **v1.3.2** (2026-05-19) — Claude Code v2.1.144 hook 기능 채택: PostToolUse 리뷰 트리거 hook, 라우팅 추천에 보안 등급·복잡도 힌트, feature-builder 의 fix/refactor 변형 분화, bash 가드의 safety-guard + test/commit-gate 분리 (차단 동작 불변). ([CHANGELOG](CHANGELOG.md))
