...
최신 릴리즈: **v1.3.0** (2026-05-15) — Bootstrap gate deadlock fix + 첫 세션 자동 bootstrap (git repo + safe path) + non-git / git-missing 환경의 degraded mode. ([CHANGELOG](CHANGELOG.md))
