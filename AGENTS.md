...
- **inbox 작업 기록은 해당 사이클의 소스 편집이 전부 끝난 뒤 작성한다** — DoD 와 같은 slug 의 inbox 파일이 생기는 순간 `pre-edit-dod-gate` 가 그 작업을 완료로 판정해 이후 소스 편집을 차단한다 (2026-07-13 incident 승격, pattern e8178927cc9108db)
